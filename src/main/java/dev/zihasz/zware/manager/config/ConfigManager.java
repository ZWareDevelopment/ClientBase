package dev.zihasz.zware.manager.config;
...
import dev.zihasz.zware.manager.Manager;
...
public class ConfigManager extends Manager {
	...
	public static final String MAIN_FOLDER = ZWare.ID + "/";
	...
	private void loadModules() throws IOException {
		...
		try (FileReader reader = new FileReader(MODULES_FILE)) {
			...
			for (Object moduleObject : modulesArray) {
				...
				Module module = ZWare.moduleManager.getModule(moduleJson.get("name").getAsString());
