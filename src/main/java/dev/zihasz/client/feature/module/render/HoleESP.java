...
public class HoleESP extends Module {
	...
	private final Setting<Mode> mode = new SettingBuilder<>(Mode.OUTLINE).name("Mode").description("Way to render holes.").build(this);
	...
	private final Setting<Color> bedrockColor = new SettingBuilder<>(new Color(40, 255, 40)).name("Bedrock Color").description("Color of bedrock holes").parent(bedrock).build(this);
	...
	private final Setting<Color> obsidianColor = new SettingBuilder<>(new Color(255, 40, 40)).name("Obsidian Color").description("Color of obsidian holes").parent(obsidian).build(this);
